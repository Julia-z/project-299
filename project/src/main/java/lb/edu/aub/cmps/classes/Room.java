...
public class Room {
	 ...
	 * public static void main(String[] args){
		...
		myRoom.id = 1;
		myRoom.number = "322";
		myRoom.room_capacity = 15;
		myRoom.building_id = 3;
		myRoom.reserved = wish;
		TimeSlot[] times2 = new TimeSlot[3];
		times2[0] = new TimeSlot();
		times2[0].setDay(Day.M);
		times2[0].setStart("0700");
		times2[0].setEnd("0800");
		times2[1] = new TimeSlot();
		times2[1].setDay(Day.W);
		times2[1].setStart("0700");
		times2[1].setEnd("0730");
		...
		System.out.println("testing reserving rooms "+ myRoom.reserveRoom(times2));
		System.out.println(myRoom.reserved);
		...
		myRoom.building_id = 3;
		myRoom.reserved = wish;
		System.out.println("testing is available method "+myRoom.is_available(times2));
	}*/
	public int getId() {
		return id;
	}
